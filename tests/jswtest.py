...
class HtmlTestCase(DisassembliesTestCase):
    ...
    def write_jsw(self, options):
        main_options = '-W ../sources:jetsetwilly.JetSetWillyHtmlWriter'
...
class SftTestCase(DisassembliesTestCase):
    def write_jsw(self, options):
        ...
        skool, error = self.run_skoolkit_command(sna2skool.main, '{} {}'.format(options, JSWZ80))
